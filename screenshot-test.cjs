...
(async () => {
  ...
  // Wait for cards to render — green header in VerifiedCard
  await page.waitForSelector('div[style*="background"]', { timeout: 10000 });
  ...
  if (buttons.length > 0) {
    ...
    console.log('Could not find Amox 250mg button');
  }
